...
/*
  ...
  Version v8.2p_2012-10-13/LGPL Development Only (2012-10-13)
...
if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _5=_2.results?_2.results.indexOf(this.$381):-1;_3=_5!=-1;if(_3){var _6=_2.results;_6=this.$455(_6);try{_2.results=isc.eval(_6,!_4)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_6)}}else{var _7=_2.operations[0];if(_7&&_7.isRestRequest){var _8=isc.DataSource.get(_7.dataSource);if(_8){if(_7&&_7.dataFormat=="json"&&_8.jsonPrefix==null)
{_3=true}else{var _9=_2.results?_2.results.indexOf(_8.jsonPrefix):-1;_3=_9!=-1}
if(_3){var _10=_2.results;_10=this.$89n(_10,_8);try{_2.results=isc.eval("("+_10+")",(_4?false:true))}catch(e){this.logWarn("Error evaling REST RPC response: "+e+" response text: "+_10);_3=false}}}}}
...
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _20=_7.application?_7.application:this.getDefaultApplication();if(isc.isA.String(_20))_20=window[_20];_20.fireCallback(_2.$40c,"responses",[_2.responses])}}
...
);isc.evalBoundary;isc.B.push(isc.A.handleTransportError=function isc_c_RPCManager_handleTransportError(_1,_2,_3,_4){}
